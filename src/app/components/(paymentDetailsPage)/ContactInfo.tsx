...
const ContactInfo = () => {
    ...
    return (
        <main>
            <Grid className="contact-info-header" container sx={{height:30}} justifyContent={"center"} alignContent={"center"}>
                <Typography variant="body1" fontWeight={'bold'}>
                    Contact Information
                </Typography>
            </Grid>

            <Grid className="contact-info-fields" container justifyContent={"center"} sx={{height:155, mt:5}}>
