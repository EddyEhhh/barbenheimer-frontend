...
const MovieDetails = ({params} : {params: {id : string}}) => {
    ...
    return (
        <main>
            ...
            <Paper elevation={5}>
                <Grid className="select-date" container sx={{mt:2, mb:2,height:65}} direction={"row"} justifyContent='center' >
            ...
            <Paper elevation={5}>
                <Grid className="select-time" container sx={{mt:4, height:65}} direction={"row"} justifyContent='center' >
                    <Grid container textAlign={"center"} alignContent={"center"} justifyContent={"center"}>
